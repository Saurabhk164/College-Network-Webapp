...
.container {  
  ...
  background-image: url("./images/gdsc.svg");  
...
<form action="" method="post">  
  <div class="container">  
  <center>  <h1> Be the part of GDSC Right Now </h1> </center>  
  <hr>  
<label> Name : </label>   
...
$result=mysqli_query($mysqli,"insert into gdsc values('$name','$roll','$contact','$year','$branch','$email')");
if($result)
{
