...
.container {  
  ...
  background-image: url("./images/kalaraag.png");  
...
<form action="" method="post">  
  <div class="container">  
  <center>  <h1> Be the part of KALARAAG Right Now </h1> </center>  
  <hr>  
<label> Name : </label>   
...
$result=mysqli_query($mysqli,"insert into kalatable values('$name','$roll','$contact','$year','$branch','$email')");
if($result)
{
