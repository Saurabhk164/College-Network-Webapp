...
.container {  
  ...
  background-image: url("./images/acmlogo.png");  
...
<form action="" method="post">  
  <div class="container">  
  <center>  <h1> Be the part of ACM Right Now </h1> </center>  
  <hr>  
<label> Name : </label>   
...
$result=mysqli_query($mysqli,"insert into acmtable values('$name','$roll','$contact','$year','$branch','$email')");
if($result)
{
